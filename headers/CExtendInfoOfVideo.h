...
@class CMessageWrap, MessageExpItem, NSString;
...
@interface CExtendInfoOfVideo : NSObject <IMessageWrapExt, IMsgExtendOperation, NSCopying>
{
    ...
    unsigned long long m_uiPlayMode;
    _Bool m_bStartPlay;
    _Bool m_bHaveMoovDownload;
    _Bool m_bComeInByClick;
    unsigned long long m_uiDownloadMode;
...
@property(nonatomic) unsigned long long m_uiDownloadMode; // @synthesize m_uiDownloadMode;
@property(nonatomic) _Bool m_bComeInByClick; // @synthesize m_bComeInByClick;
@property(nonatomic) _Bool m_bHaveMoovDownload; // @synthesize m_bHaveMoovDownload;
@property(nonatomic) _Bool m_bStartPlay; // @synthesize m_bStartPlay;
@property(nonatomic) unsigned long long m_uiPlayMode; // @synthesize m_uiPlayMode;
