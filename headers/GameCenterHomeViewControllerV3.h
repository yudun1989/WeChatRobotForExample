...
@class GameCenterBottomView, GameCenterHeaderView, GameCenterHomeLogicControllerV3, GameCenterSearchLogicController, MMLoadingView, MMTableView, NSMutableArray, NSString, UIView;
...
- (id)makeRecentCellWithReusableCell:(id)arg1 identifier:(id)arg2 index:(long long)arg3;
