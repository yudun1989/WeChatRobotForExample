...
@class NSMutableDictionary, NSString, SightView, UIButton;
...
@interface WCCanvasSightComponent : WCCanvasComponent <SightViewDelegate, WCCanvasImageLoaderObserver, WCSightLoaderObserver, VoiceComponentExt>
{
    ...
    NSMutableDictionary *_sightUrl2SoundMap;
...
@property(retain, nonatomic) NSMutableDictionary *sightUrl2SoundMap; // @synthesize sightUrl2SoundMap=_sightUrl2SoundMap;
