...
@interface EmoticonBoardView : MMUIView <IMMLanguageMgrExt, MMKernelExt, IEmoticonPackageMgrExt, EmoticonGridViewDelegate, EmoticonRecommendMgrExt, QQEmojiGridViewDelegate, IEmoticonMgrExt, EmoticonTabItemViewDelegate, UIScrollViewDelegate, EmoticonTabRecommendMgrExt, EmoticonBoardRecommendViewDelegate, EmoticonBoardPageCollectionControllerDelegate>
{
