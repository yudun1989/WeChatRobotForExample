...
@interface WAHomeViewLayout : UICollectionViewFlowLayout <UIGestureRecognizerDelegate>
{
...
@property(readonly, nonatomic) id <WAHomeViewLayoutDelegate> delegate;
@property(readonly, nonatomic) id <WAHomeViewLayoutDataSource> dataSource;
