...
@interface WCListView : MMUIView <WCActionSheetDelegate, UITableViewDelegate, UITableViewDataSource, WCImageViewDelegate, MMRefreshTableFooterDelegate, WCListViewDelegate, WCFacadeExt, WCListHeaderViewDelegate, WCPuzzleImageViewDelegate, tableViewDelegate, MMTipsViewControllerDelegate, WCCommentDetailViewControllerFBDelegate, IUiUtilExt, MMImagePickerManagerDelegate>
{
    _Bool m_isMyWC;
    CContact *m_contact;
