...
@interface VOIPCSMgr : MMService <INetworkStatusMgrExt, PBMessageObserverDelegate, MMService, AVVideoDeviceSessionDelegate, AVVideoDataSource, AUAudioDataSource, ISysCallCheckExt>
{
    ...
    unsigned int _mMaxBitRate;
    unsigned int _mMaxFPS;
...
@property(nonatomic) unsigned int mMaxFPS; // @synthesize mMaxFPS=_mMaxFPS;
@property(nonatomic) unsigned int mMaxBitRate; // @synthesize mMaxBitRate=_mMaxBitRate;
