...
@interface BrandSessionMgr : MMService <ISessionStorageDelegate, ChatMigrationRecoverNotificationExt, ISessionInfoExt, MMService, IMsgExt, IContactMgrExt, IMMNewSessionMgrExt>
{
