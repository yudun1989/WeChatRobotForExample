...
@class CBaseContact, MMTableView, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NewContactsSearchPanelView;
...
@interface RoomContactSelectViewController : MMSearchBarDisplayController <tableViewDelegate, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, NewContactsSearchPanelViewDelegate>
{
    ...
    NSArray *_m_customMemberList;
}

@property(retain, nonatomic) NSArray *m_customMemberList; // @synthesize m_customMemberList=_m_customMemberList;
