...
@property(nonatomic) _Bool m_bComeInByClick; // @dynamic m_bComeInByClick;
@property(nonatomic) _Bool m_bHaveMoovDownload; // @dynamic m_bHaveMoovDownload;
@property(nonatomic) _Bool m_bStartPlay; // @dynamic m_bStartPlay;
...
@property(nonatomic) unsigned long long m_uiDownloadMode; // @dynamic m_uiDownloadMode;
@property(nonatomic) unsigned long long m_uiPlayMode; // @dynamic m_uiPlayMode;
