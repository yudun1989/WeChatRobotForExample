...
@class CContact, CContactDB, CContactOPLog, NSMutableDictionary, NSRecursiveLock, NSString, NewContactDB;
...
- (unsigned int)getContactCount:(unsigned int)arg1 contactType:(unsigned int)arg2;
