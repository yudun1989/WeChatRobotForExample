...
@interface WCSightView : MMUIControl <SightViewDelegate, WCNetworkMediaPlayerDelegate, IUiUtilExt, WCFacadeExt, UIActionSheetDelegate, WCSightFullPlayViewControllerDelegate>
{
