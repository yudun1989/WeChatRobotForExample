...
@class AppStoreControl, BaseResponse, FeedBackEntrance, GameManagement, GameRecommend, IndexGift, IndexTheme, Installed, LibraryEntrance, NSString, NewHot, RecentPlayInfo, TopRecommendBanner;
