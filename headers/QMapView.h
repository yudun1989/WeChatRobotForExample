...
@class CLLocationManager, NSArray, NSMutableArray, NSOperationQueue, NSString, QAnnotationFloor, QBaseView, QCircle, QMapAnimationContainer, QOverlayFloor, QScaleView, QUserLocation, QViewRecycler, UIImageView, UILabel, UILongPressGestureRecognizer, UIPinchGestureRecognizer, UITapGestureRecognizer;
...
- (void)setupRenderContainer:(int)arg1;
- (void)setupBaseView;
- (void)setupSelf;
