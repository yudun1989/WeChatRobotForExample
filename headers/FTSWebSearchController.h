...
@interface FTSWebSearchController : NSObject <UISearchBarDelegate, UIWebViewDelegate, UIScrollViewDelegate, WCCommentDetailViewControllerFBDelegate, FTSJSEventDelegate, FTSWebSearchDataSource, INewABTestMgrExt, WSMusicDelegate, WAContactMgrExtension>
{
