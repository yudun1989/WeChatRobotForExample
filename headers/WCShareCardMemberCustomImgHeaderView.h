...
- (void)setupView;
- (id)initWithViewWidth:(double)arg1 withCardSourceData:(id)arg2 isShareCard:(_Bool)arg3 cardStatus:(int)arg4 isNeedHideAcceptBtn:(_Bool)arg5 delegate:(id)arg6 isHasDetailView:(_Bool)arg7 giftInfo:(id)arg8 cardImgView:(id)arg9;
